  ...
  return (
    <Card className="bg-zinc-900/70 border-zinc-800 backdrop-blur-sm col-span-1 flex flex-col">
      <CardContent className="p-0">
        {/* Profile Header for mobile layout */}
        ...
        {/* styling fot contact session on desktop (for now) */}
        <div className="border-b border-zinc-800">
          <div className="w-full bg-transparent border-b border-zinc-800 rounded-none h-auto p-0">
            <div className="flex-1 rounded-none border-b-2 border-cyan-400 px-2 sm:px-4 py-2 text-xs sm:text-sm text-white flex items-center justify-center bg-gradient-to-r from-cyan-500/20 to-blue-500/20">
        ...
        <Tabs defaultValue="contact" className="w-full">
          <TabsContent value="contact" className="p-4 sm:p-6 space-y-4 focus:outline-none block">
